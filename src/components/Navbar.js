...
class Navbar extends Component{
   ...
   render(){
       return(
           ...
           <a className="navbar-brand" href="http://localhost:3000/">IMDEV</a>
           ...
           <div className="collapse navbar-collapse" id="navbarSupportedContent">
               ...
               <input className="form-control mr-sm-2" type="search" placeholder="Buscar pelicula" aria-label="Search"/>
